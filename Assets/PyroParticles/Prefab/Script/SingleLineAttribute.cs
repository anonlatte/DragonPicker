...
namespace DigitalRuby.PyroParticles
{
    ...
    public class SingleLineDrawer : PropertyDrawer
    {
        ...
        private void DrawRangeField(Rect position, float labelWidth, float textFieldWidth, SerializedProperty prop,
            bool floatingPoint)
        {
        ...
        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
        {
            ...
            switch (prop.type)
            {
                ...
                default:
                    EditorGUI.HelpBox(position, "[Compact] doesn't work with type '" + prop.type + "'",
                        MessageType.Error);
                    break;
            }
