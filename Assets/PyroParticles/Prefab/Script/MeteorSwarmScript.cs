...
namespace DigitalRuby.PyroParticles
{
    ...
    public class MeteorSwarmScript : FireBaseScript, ICollisionHandler
    {
        ...
        [Tooltip("The destination radius")] public float DestinationRadius;

        [Tooltip("The source of the meteor swarm (in the sky somewhere usually)")]
        public Vector3 Source;

        [Tooltip("The source radius")] public float SourceRadius;
        ...
        private IEnumerator SpawnMeteor()
        {
            ...
            t.startWidth = Random.Range(2.0f, 3.0f) * scale;
            ...
            if (EmissionSounds != null && EmissionSounds.Length != 0)
            {
                ...
                if (audio != null)
                {
                    int index = Random.Range(0, EmissionSounds.Length);
        ...
        {
            int count = (int)Random.Range(MeteorsPerSecondRange.Minimum, MeteorsPerSecondRange.Maximum);
