...
namespace DigitalRuby.PyroParticles
{
    ...
    public class LoopingAudioSource
    {
        ...
        public LoopingAudioSource(MonoBehaviour script, AudioSource audioSource, float startMultiplier,
        ...
        public void Update()
        {
            if (AudioSource != null && AudioSource.isPlaying &&
                (AudioSource.volume =
                    Mathf.Lerp(AudioSource.volume, TargetVolume, Time.deltaTime / currentMultiplier)) == 0.0f)
            {
                AudioSource.Stop();
            }
        }
    ...
    {
        [HideInInspector] public LoopingAudioSource LoopingAudioSource;
